                ...
                {pendingVerification === false ? (
                    <>
                        <div className="text-center mb-8">
                            ...
                            <h2 className="text-2xl font-semibold text-gray-800 mt-4">Create Client Account</h2>
                            <p className="text-gray-600 mt-2">Join us to order delicious homemade meals</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className={`w-full py-3 px-4 rounded-lg font-medium text-white transition ${loading ? 'bg-rose-400 cursor-not-allowed' : 'bg-rose-600 hover:bg-rose-700'}`}
                            >
                    ...
                    <div className="text-center">
                        ...
                        <button
                            ...
                            disabled={loading}
                            className={`mt-4 w-full py-3 px-4 rounded-lg font-medium text-white transition ${loading ? 'bg-rose-400 cursor-not-allowed' : 'bg-rose-600 hover:bg-rose-700'}`}
                        >
