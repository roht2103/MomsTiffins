    ...
    <div className="bg-gray-50 min-h-screen flex items-center justify-center">
      <div className="w-full max-w-lg px-4">
        ...
        <div className="bg-white p-6 md:p-8 rounded-xl shadow-md text-center">
          <h1 className="text-gray-800 text-3xl md:text-4xl font-bold mb-4">Welcome to Mother's Tiffin</h1>
          <p className="text-gray-500 text-lg md:text-xl mb-8">Where homemade meets happiness!</p>
          ...
          <div className="flex flex-col gap-4 mb-8">
            ...
            >
              ...
              <span className="text-lg font-medium">I want to eat delicious homemade food</span>
            </button>
            ...
            >
              <span className="text-3xl md:text-4xl">👩‍🍳</span>
              <span className="text-lg font-medium">I want to serve my delicious food</span>
            </button>
          </div>
